...
/**
 * Classe utilitaire pour l'affichage des déplacements, les classes d'Android n'étant pas assez "évoluées".
 * @author Joël Troch
 */
...
public class AdaptateurListeDeplacements extends BaseAdapter {
	 ...
	 * @param liste Liste des déplacements.
	...
	/**
	 * Récupère le nombre de déplacements dans la liste.
	...
	/**
	 * Récupère un déplacement selon sa position dans la liste.
	 * @return Déplacement à la position spécifiée dans la liste.
