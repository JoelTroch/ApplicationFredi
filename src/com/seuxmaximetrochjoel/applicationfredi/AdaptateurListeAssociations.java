...
/**
 * Classe utilitaire pour l'affichage des associations, les classes d'Android n'étant pas assez "évoluées".
 * @author Joël Troch
 */
...
public class AdaptateurListeAssociations extends BaseAdapter {
	...
	/**
	 * Récupère le nombre d'associations dans la liste.
	...
	/**
	 * Récupère une association selon sa position dans la liste.
	 * @return Association à la position spécifiée dans la liste.
